...
static blog::Logger::ptr g_logger = TIDE_LOG_NAME("orm");
...
std::string UserInfo::toJsonString() const {
    ...
    jvalue["login_time"] = blog::Time2Str(m_loginTime);
    jvalue["is_deleted"] = m_isDeleted;
    jvalue["create_time"] = blog::Time2Str(m_createTime);
    jvalue["update_time"] = blog::Time2Str(m_updateTime);
    return blog::JsonUtil::ToString(jvalue);
}
...
int UserInfoDao::Update(UserInfo::ptr info, blog::IDB::ptr conn) {
    ...
    if(!stmt) {
        TIDE_LOG_ERROR(g_logger) << "stmt=" << sql
...
int UserInfoDao::Insert(UserInfo::ptr info, blog::IDB::ptr conn) {
...
int UserInfoDao::InsertOrUpdate(UserInfo::ptr info, blog::IDB::ptr conn) {
    if(info->m_id == 0) {
...
int UserInfoDao::Delete(UserInfo::ptr info, blog::IDB::ptr conn) {
...
int UserInfoDao::DeleteById( const int64_t& id, blog::IDB::ptr conn) {
    std::string sql = "delete from user where id = ?";
    auto stmt = conn->prepare(sql);
    if(!stmt) {
        TIDE_LOG_ERROR(g_logger) << "stmt=" << sql
...
int UserInfoDao::DeleteByAccount( const std::string& account, blog::IDB::ptr conn) {
...
int UserInfoDao::DeleteByEmail( const std::string& email, blog::IDB::ptr conn) {
...
int UserInfoDao::DeleteByName( const std::string& name, blog::IDB::ptr conn) {
...
int UserInfoDao::QueryAll(std::vector<UserInfo::ptr>& results, blog::IDB::ptr conn) {
...
UserInfo::ptr UserInfoDao::Query( const int64_t& id, blog::IDB::ptr conn) {
...
UserInfo::ptr UserInfoDao::QueryByAccount( const std::string& account, blog::IDB::ptr conn) {
...
UserInfo::ptr UserInfoDao::QueryByEmail( const std::string& email, blog::IDB::ptr conn) {
...
UserInfo::ptr UserInfoDao::QueryByName( const std::string& name, blog::IDB::ptr conn) {
...
int UserInfoDao::CreateTableSQLite3(blog::IDB::ptr conn) {
...
int UserInfoDao::CreateTableMySQL(blog::IDB::ptr conn) {
    return conn->execute("CREATE TABLE user("
